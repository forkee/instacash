/* src/config/instacash-config.h.  Generated from instacash-config.h.in by configure.  */
/* src/config/instacash-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.instacash.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "InstaCash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "InstaCash Core 1.0.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "instacash"
